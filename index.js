...
console.log('task 1a', createMenuItems('tacos',8,'Lunch'));
...
console.log('task 1b',createMenuItem('hotdog',2,'lunch'));
console.log('task 1b',createMenuItem('soup',8,'dinner'));
...
function addReview(name, rating, feedback){
  reviews.push[{name: 'Cris', rating: 5, feedback: 'This place is pretty cool,'}]
};
console.log(reviews);
